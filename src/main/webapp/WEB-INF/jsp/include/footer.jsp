    ...
    <script src="${pageContext.request.contextPath}/resources/sb-admin/vendor/raphael/raphael.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/sb-admin/vendor/morrisjs/morris.min.js"></script>
